...
class Select extends BaseComponent {
    ...
    stateClasses = {
        ...
        isOnTheLeftSide: 'is-on-the-laft-side',
    ...
    updateUI() {
        ...
        const newSeletedOptionValue = selectedOptionElement.textContent.trim()

        const updateOriginalControl = () => {
            this.originalControlElement.value = newSeletedOptionValue
        }

        const updateButton = () => {
            this.buttonElement.textContent = newSeletedOptionValue
    ...
    updateTadIndexes(isMobileDevice = MatchMedia.mobile.matches) {
    ...
    onMobileMatchMediaChange = (event) => {
        this.updateTadIndexes(event.matches)
    }
